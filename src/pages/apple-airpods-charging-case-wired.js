      ...
      <article className='prose max-w-none pt-10 pb-8'>
        <figure className='text-center'>
          <img
            ...
            decoding='async'
          />
          <figcaption><span>Photo by <a href="https://unsplash.com/@omidarmin?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Omid Armin</a> on <a href="https://unsplash.com/s/photos/apple-airpod-2?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span></figcaption>
        </figure>
        <p>
          Happiness can be found even in the simplest of things. The sound of wind breeze, looking at the sky and finding an alluring shade of blue or listening to our favorite song that takes you away to that special place.
          In a world of instant gratification and being surrounded by pings and notifications, it’s hard to find that happiness in an electronic gadget. Then, along came the Apple AirPods. On the face of it, it’s a simple gadget where Apple just chopped the wires from its earphones and presented it to the world.
        </p>
        <hr />
        <h2>Design</h2>
        <p>
        ...
        <hr />
        <h2>Making calls and using Siri</h2>
        <p>Double tapping the AirPods activates Siri, as long as your phone has a web connection. You can then use Siri in the same way you would control the personal assistant on your phone. Shouting commands into, what to others looks like thin air, is unnerving though, and making calls while wearing AirPods is a similarly strange experience. Many of us have become accustomed to seeing other people talking to themselves before noticing their mouthpiece attached to earphones. At the wrong angle, AirPods seemingly vanish making it look like you're actually talking to yourself.</p>
        <hr />
        <h2>Battery life</h2>
        <p>The improved battery life is likely due to the newer H1 chip inside, that, on top of helping with connecting to your source devices, also plays a key role in power management</p>
        <hr />
